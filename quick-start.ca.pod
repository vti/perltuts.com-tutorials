...
Imprimiu només els valors senars de C<0> a C<10>:
    ...
    __TEST__
    like($stdout, qr/1\n3\n5\n7\n9/, 'Hauria d'imprimir valors senars');

=head3 Sortint d'un bucle
...
Alguns caràcters (com C<|> en l'exemple anterior) són especials dins les
